...
public class Aluno implements Serializable{
	...
	private static final long serialVersionUID = -3776455962963722481L;
	...
	@Column(name = "RG", nullable = false, length = 16)
	private Integer rg;
	...
	public void gerarMatricula(String maxMatricula) {
		...
		sequencia++;
		this.matricula= year + StringUtils.leftZeros(sequencia, 4);
	}
